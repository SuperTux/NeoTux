...
local _data = dofile(arg[1] or 'lua_capi_data.lua')
local _outfile = (arg[2] or (_header_mode and "output.hpp" or "output.cpp"))
...
local fh = io.open(_outfile, "w")
fh:write((_header_mode and generate_header() or generate_cxx()) .. '\n')
