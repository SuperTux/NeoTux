...
public:
	...
	virtual void on_collision(Sector &sector, MovingObject &obj,
	                          Collision::CollideInfo<float> collide)
	{
	}

	void do_slope_collision(uint16_t sl_t, Vec2 line_beg, Vec2 line_end,
...
public:
	Physics m_physics;
	bool m_likes_falling, m_grounded, m_on_slope, m_collidable, m_tilelike;
