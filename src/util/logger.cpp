...
void
Logger::log(Level lv, const std::string &lvname, const std::string &cat, const std::string &msg)
{
...
void
Logger::log(Level lv, const std::string &lvname, const std::string &msg)
{
	std::ostream &stream = (lv == ERROR) ? std::cerr : std::cout;
...
std::string
Logger::get_color_code(Level lv)
{
